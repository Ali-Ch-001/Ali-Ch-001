...
- **Architecting:** Production-grade agentic systems, RAG pipelines, and scalable VPS infrastructure.
- **Exploring:** High-frequency trading infrastructure, quantitative finance systems, and low-latency environments.
- **Building:** High-performance web applications that bridge complex LLM orchestration with seamless, secure user experiences.
- **Ask me about:** System architecture, Vector Databases, LangChain, OpenClaw, Python, C++, TypeScript, and Next.js.
- **Fun Fact:** I built SehatSaathi an award-winning, multilingual offline AI health assistant for a hackathon.
...
![Hugging Face](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-FDEE21?style=flat&logoColor=black)
